...
function Footer() {
  return (
    <div className="px-5 lg:px-20 py-5 md:py-10 flex flex-col items-center gap-y-5 md:flex-row md:justify-between md:items-start text-center md:text-left text-xs text-grayish-violet bg-very-dark-violet">
      ...
      <div>
        <h2 className="mb-3 text-white font-semibold">Features</h2>
        <Link href={"/"} className="block mb-1">Link Shortening</Link>
        <Link href={"/"} className="block mb-1">Branded Links</Link>
        <Link href={"/"} className="block mb-1">Analytics</Link>
      </div>

      <div>
        <h2 className="mb-3 text-white font-semibold">Resources</h2>
        <Link href={"/"} className="block mb-1">Blog</Link>
        <Link href={"/"} className="block mb-1">Developers</Link>
        <Link href={"/"} className="block mb-1">Support</Link>
      </div>

      <div>
        <h2 className="mb-3 text-white font-semibold">Company</h2>
        <Link href={"/"} className="block mb-1">About</Link>
        <Link href={"/"} className="block mb-1">Our Team</Link>
        <Link href={"/"} className="block mb-1">Careers</Link>
        <Link href={"/"} className="block mb-1">Contact</Link>
      </div>
      <div>
        <Image
